...
app.post('/registroMercancia', (req, res) => {
...
// Registro de buque
app.post('/registroBuque', (req, res) => {
...
app.post('/registroTransportista', (req, res) => {
...
app.post('/registroVehiculo', (req, res) => {
...
app.post('/registroOperacion', (req, res) => {
  const {
    referencia,
    cliente_id,
    exportador_id,
...
app.get('/tabla/:tableName', (req, res) => {
...
app.get('/tablaReferencia', (req, res) => {
  const { referencia } = req.query; // Cambiado req.body por req.query
  ...
  connection.query(sql, [referencia], (err, results) => {
    ...
    console.log('se imprime ', sql, [referencia]);
    res.json(results);
  });
});


app.get('/VerTablaOperacion', (req, res) => {
...
app.post('/Aumentoestatus', (req, res) => {
...
app.put('/UpdateOperacion', (req, res) => {
  const {
    referencia,
    cliente_id,
    exportador_id,
